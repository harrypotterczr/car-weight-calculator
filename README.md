...
- **导出与归档**:
  ...
  - **数据归档**: 点击"轿厢重量归档"按钮，将当前计算数据归档至 `轿厢重量汇总.json`。
    - 若该项目号已有归档数据，弹出二次确认提示框（明确提示"数据将被替换"），确认后覆盖旧数据。
  - **导入数据**: 点击"导入数据"按钮，从归档数据（`轿厢重量汇总.json`）中选取项目回填至表单。
    - 列表展示所有已归档项目的项目号、电梯型号及归档时间。
    - 支持搜索框模糊搜索项目号和电梯型号。
    - 单选项目后点击确认，系统自动将该项目的参数和重量明细回填至网页对应表单位置。
